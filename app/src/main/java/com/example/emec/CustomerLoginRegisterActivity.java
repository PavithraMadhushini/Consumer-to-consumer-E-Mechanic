...
public class CustomerLoginRegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomerLoginButton = (Button) findViewById(R.id.customerLogin);
        CustomerRegisterButton = (Button) findViewById(R.id.customerRegistration);
        CustomerRegisterLink = (TextView) findViewById(R.id.CusRegLink);
        CustomerStatus = (TextView) findViewById(R.id.textView3);
